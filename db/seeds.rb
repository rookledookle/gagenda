...
# Students #
u21 = User.create(name:'Tally', email:'tally@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u22 = User.create(name:'Berry', email:'berry@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u23 = User.create(name:'Magnolia', email:'magnolia@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u24 = User.create(name:'Lucienne', email:'lucienne@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u25 = User.create(name:'Rhys', email:'rhys@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u26 = User.create(name:'Henry', email:'henry@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u27 = User.create(name:'Darrion', email:'darrion@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u28 = User.create(name:'Wart', email:'wart@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u29 = User.create(name:'Emery', email:'emery@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u30 = User.create(name:'Indya', email:'indya@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u31 = User.create(name:'Haroun', email:'haroun@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u32 = User.create(name:'Piano', email:'piano@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u33 = User.create(name:'Manolo', email:'manolo@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u34 = User.create(name:'Ayn', email:'ayn@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u35 = User.create(name:'Isolde', email:'isolde@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u36 = User.create(name:'Robert', email:'robert@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u37 = User.create(name:'Lennon', email:'lennon@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u38 = User.create(name:'Clay', email:'clays@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u39 = User.create(name:'Bowie', email:'bowie@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u40 = User.create(name:'Rex', email:'rex@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u41 = User.create(name:'Coy', email:'coy@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u42 = User.create(name:'Cash', email:'cash@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u43 = User.create(name:'Amedeo', email:'amedeo@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u44 = User.create(name:'Kai', email:'kai@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u45 = User.create(name:'Hiro', email:'hiro@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u46 = User.create(name:'Robin', email:'robin@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u47 = User.create(name:'Erik', email:'erik@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u48 = User.create(name:'Lua', email:'lua@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u49 = User.create(name:'Georgette', email:'georgette@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
u50 = User.create(name:'Bruno', email:'bruno@gmail.com', password: 'password',password_confirmation: 'password', role_id:1)
