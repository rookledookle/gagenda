...
# USERS #
# ADMIN #
u1 = User.create(name:'Clyde', email:'clyde@ga.com', password: 'password',password_confirmation: 'password')
u2 = User.create(name:'Ash', email:'ash@ga.com', password: 'password',password_confirmation: 'password')
u3 = User.create(name:'Beckett', email:'beckett@ga.com', password: 'password',password_confirmation: 'password')
u4 = User.create(name:'Bronwyn', email:'bronwyn@ga.com', password: 'password',password_confirmation: 'password')
u5 = User.create(name:'Cruz', email:'cruz@ga.com', password: 'password',password_confirmation: 'password')
u6 = User.create(name:'Delaney', email:'delaney@ga.com', password: 'password',password_confirmation: 'password')
u7 = User.create(name:'Levi', email:'levi@ga.com', password: 'password',password_confirmation: 'password')
u8 = User.create(name:'Ned', email:'ned@ga.com', password: 'password',password_confirmation: 'password')
u9 = User.create(name:'Felix', email:'felix@ga.com', password: 'password',password_confirmation: 'password')
u10 = User.create(name:'Angelica', email:'angelica@ga.com', password: 'password',password_confirmation: 'password')
u11 = User.create(name:'Mae', email:'mae@ga.com', password: 'password',password_confirmation: 'password')
u12 = User.create(name:'Camilla', email:'camilla@ga.com', password: 'password',password_confirmation: 'password')
u13 = User.create(name:'Faye', email:'faye@ga.com', password: 'password',password_confirmation: 'password')
u14 = User.create(name:'Wylie', email:'wylie@ga.com', password: 'password',password_confirmation: 'password')
u15 = User.create(name:'Cade', email:'cade@ga.com', password: 'password',password_confirmation: 'password')
u16 = User.create(name:'Landon', email:'landon@ga.com', password: 'password',password_confirmation: 'password')
u17 = User.create(name:'Truman', email:'truman@ga.com', password: 'password',password_confirmation: 'password')
u18 = User.create(name:'Bob', email:'bob@ga.com', password: 'password',password_confirmation: 'password')
u19 = User.create(name:'Dick', email:'dick@ga.com', password: 'password',password_confirmation: 'password')
u20 = User.create(name:'Tod', email:'tod@ga.com', password: 'password',password_confirmation: 'password')
